            ...
            <div class="row justify-content-center">
              <div class="col-lg-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                  ...
                  <div class="card-body">
                    <div class="small mb-3 text-muted">Enter your email address or username, and we will send you a link
                    ...
                    <form action="" method="POST">
                      <div class="form-floating mb-3">
                        <input class="form-control" id="inputEmail" type="text" name="username"
                          value="<?php echo $session->getFlashdata('username') ?>" placeholder="name@example.com" />
                      ...
                      <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                        ...
                        <input type="submit" class="btn btn-primary" name="submit" value="Send Recovery Email">
                      </div>
                    </form>
                  </div>
                </div>
